...
#    endif
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), reciprocal(test4), 0.1f, 0.25f,
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), ceil(test20), 4.0f, 0.0f, -7.0f,
        -1.0f, 6.0f, -3.0f, 7.0f, -2.0f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), floor(test20), 3.0f, -1.0f, -8.0f,
        -2.0f, 5.0f, -4.0f, 6.0f, -3.0f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), trunc(test20), 3.0f, 0.0f, -7.0f,
        -1.0f, 5.0f, -3.0f, 6.0f, -2.0f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), sqrt(test4.abs()), 3.16227766f, 2.0f,
        2.645751311f, 2.236067977f, 1.414213562f, 1.414213562f, 3.0f, 2.236067977f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), rsqrt(test4.abs()), 0.316227766f,
        0.5f, 0.377964473f, 0.4472135955f, 0.7071067812f, 0.7071067812f, 0.333333333333f, 0.4472135955f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), log2(test4.abs()),
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), log(test4.abs()),
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), exp2(test4), 1024.0f, 16.0f, 128.0f,
        32.0f, 4.0f, 0.25f, 512.0f, 0.03125f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), exp(test4),
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), pow(test8, test4), 13.78584918f,
        3.8416f, 17.0859375f, 10.48576f, 3.61f, 0.826446280991f, -38.443359375f, 0.0529221494013f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), pow(test8, test7), 6.2748517f,
        -0.1859344321f, 2.25f, 0.24414062f, 1.9f, 1.771561f, -86.49755859f, 0.0090744426f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), powr(test8.abs(), test4),
        13.78584918f, 3.8416f, 17.0859375f, 10.48576f, 3.61f, 0.826446280991f, 38.443359375f, 0.0529221494013f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), pow(test8, TestType::BaseDef(4.0f)),
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), sin(test22), 0.4968801361f,
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), cos(test22), 0.8678191802f,
        0.2674988286f, 0.7365390393f, 0.5062202572f, -0.8568887533f, -0.8568887533f, 0.8376784145f, 0.5062202572f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), cos(-test22), 0.8678191802f,
        0.2674988286f, 0.7365390393f, 0.5062202572f, -0.8568887533f, -0.8568887533f, 0.8376784145f, 0.5062202572f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), tan(test22), 0.5725618303f,
    ...
    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), asin(sin(test22)), 0.52f, 1.3f,
        0.7428571429f, 1.04f, 0.5415926535f, -0.5415926535f, 0.5777777f, -1.04f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), asin(sin(-test22)), -0.52f, -1.3f,
        -0.7428571429f, -1.04f, -0.5415926535f, 0.5415926535f, -0.5777777f, 1.04f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), acos(cos(test22)), 0.52f, 1.3f,
        0.7428571429f, 1.04f, 2.6f, 2.6f, 0.5777777f, 1.04f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), acos(cos(-test22)), 0.52f, 1.3f,
        0.7428571429f, 1.04f, 2.6f, 2.6f, 0.5777777f, 1.04f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), atan(tan(test22)), 0.52f, 1.3f,
        0.7428571429f, 1.04f, -0.5415926535f, 0.5415926535f, 0.5777777f, -1.04f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), atan(tan(-test22)), -0.52f, -1.3f,
        -0.7428571429f, -1.04f, 0.5415926535f, -0.5415926535f, -0.5777777f, 1.04f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), atan2(test22, test7), 0.074149519f,
        2.8872247f, 0.35563585f, 2.80789f, 1.20362f, -0.408908f, 0.052477f, -3.01232f);

    ASSERT_PRED9((assertSIMD8<typename TestFixture::TypeInt, TestFixture::width>), atan2(test7, test22), 1.4966468f,
