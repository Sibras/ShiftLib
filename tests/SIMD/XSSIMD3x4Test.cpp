...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(SIMD3x4Test)
...
TYPED_TEST_SUITE(TESTISA(SIMD3x4), SIMD3x4TestTypes);

TYPED_TEST_NS2(SIMD3x4, TESTISA(SIMD3x4), SIMD3x4)
{
