...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(SIMD16Test)
...
TYPED_TEST_SUITE(TESTISA(SIMD16), SIMD16TestTypes);

TYPED_TEST_NS2(SIMD16, TESTISA(SIMD16), SIMD16)
{
...
#    endif
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), reciprocal(test4), 0.1f, 0.25f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), ceil(test20), 4.0f, 0.0f, -7.0f,
        -1.0f, 6.0f, -3.0f, 7.0f, -2.0f, -7.0f, -4.0f, 4.0f, -3.0f, -9.0f, 4.0f, 11.0f, -2.0f);

    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), floor(test20), 3.0f, -1.0f, -8.0f,
        -2.0f, 5.0f, -4.0f, 6.0f, -3.0f, -8.0f, -5.0f, 3.0f, -4.0f, -10.0f, 3.0f, 10.0f, -3.0f);

    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), trunc(test20), 3.0f, 0.0f, -7.0f,
        -1.0f, 5.0f, -3.0f, 6.0f, -2.0f, -7.0f, -4.0f, 3.0f, -3.0f, -9.0f, 3.0f, 10.0f, -2.0f);

    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), sqrt(test4.abs()), 3.16227766f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), rsqrt(test4.abs()), 0.316227766f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), log2(test4.abs()),
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), log(test4.abs()),
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), exp2(test4), 1024.0f, 16.0f,
        128.0f, 32.0f, 4.0f, 0.25f, 512.0f, 0.03125f, 0.000976563f, 0.0625f, 0.0078125f, 0.03125f, 0.25f, 4.0f,
        0.00195313f, 32.0f);

    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), exp(test4),
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), pow(test8, test4), 13.78584918f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), pow(test8, test7), 6.2748517f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), powr(test8.abs(), test4),
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), sin(test22), 0.4968801361f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), cos(test22), 0.8678191802f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), tan(test22), 0.5725618303f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), asin(sin(test22)), 0.52f, 1.3f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), acos(cos(test22)), 0.52f, 1.3f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), atan(tan(test22)), 0.52f, 1.3f,
        0.7428571429f, 1.04f, -0.5415926535f, 0.5415926535f, 0.5777777f, -1.04f, -0.52f, -1.3f, -0.7428571429f, -1.04f,
        0.5415926535f, -0.5415926535f, -0.5777777f, 1.04f);
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), atan2(test22, test7), 0.074149519f,
    ...
    ASSERT_PRED17((assertSIMD16<typename TestFixture::TypeInt, TestFixture::width>), atan2(test7, test22), 1.4966468f,
