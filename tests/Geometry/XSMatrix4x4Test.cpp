...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(MATRIX4X4)
...
TYPED_TEST_SUITE(TESTISA(Matrix4x4Test), Matrix4x4TestTypes);

TYPED_TEST2(TESTISA(Matrix4x4Test), Matrix4x4)
{
