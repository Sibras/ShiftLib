...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(MATRIX4X3)
...
TYPED_TEST_SUITE(TESTISA(Matrix4x3Test), Matrix4x3TestTypes);

TYPED_TEST2(TESTISA(Matrix4x3Test), Matrix4x3)
{
