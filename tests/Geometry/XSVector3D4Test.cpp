...
using Vector3D4TestTypes =
    ::testing::Types<Vector3D4<float, true, SIMDWidth::Scalar>, Vector3D4<float, false, SIMDWidth::Scalar>,
        Vector3D4<float, true, SIMDWidth::B16>, Vector3D4<float, false, SIMDWidth::B16>,
        Vector3D4<float, true, SIMDWidth::B32>, Vector3D4<float, false, SIMDWidth::B32>,
        Vector3D4<float, true, SIMDWidth::B64>, Vector3D4<float, false, SIMDWidth::B64>>;
...
TYPED_TEST_NS2(Vector3D4, TESTISA(V3D4), Vector3D4)
{
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test1,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test2,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test3,
        5.234f, 1.836f, -5.2789f, 1.0f, 7.2654f, -1.0547f, 8.254f, 0.0f, -5.234f, -1.836f, 5.2789f, -1.0f);

    TestType test4 = TestType(test1);
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test4,
        10.0f, 4.0f, 7.0f, 5.0f, 2.0f, -2.0f, 9.0f, -5.0f, -10.0f, -4.0f, -7.0f, -5.0f);
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test5,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>),
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test6,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test7,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test8,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test9,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test14,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test10,
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test11,
        10.0f, 4.0f, 7.0f, 5.0f, 2.0f, -2.0f, 9.0f, -5.0f, -10.0f, -4.0f, -7.0f, -5.0f);
    ...
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test12,
        -10.0f, -4.0f, -7.0f, -5.0f, -2.0f, 2.0f, -9.0f, 5.0f, 10.0f, 4.0f, 7.0f, 5.0f);
