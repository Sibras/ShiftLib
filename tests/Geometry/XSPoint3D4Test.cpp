...
using Point3D4TestTypes =
    ::testing::Types<Point3D4<float, true, SIMDWidth::Scalar>, Point3D4<float, false, SIMDWidth::Scalar>,
        Point3D4<float, true, SIMDWidth::B16>, Point3D4<float, false, SIMDWidth::B16>,
        Point3D4<float, true, SIMDWidth::B32>, Point3D4<float, false, SIMDWidth::B32>,
        Point3D4<float, true, SIMDWidth::B64>, Point3D4<float, false, SIMDWidth::B64>>;
...
TYPED_TEST_NS2(Point3D4, TESTISA(P3D4), Point3D4)
{
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test1,
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test2,
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test3,
        5.234f, 1.836f, -5.2789f, 1.0f, 7.2654f, -1.0547f, 8.254f, 0.0f, -5.234f, -1.836f, 5.2789f, -1.0f);

    TestType test4 = TestType(test1);
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test4,
        10.0f, 4.0f, 7.0f, 5.0f, 2.0f, -2.0f, 9.0f, -5.0f, -10.0f, -4.0f, -7.0f, -5.0f);
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test5, 1.3f,
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test9,
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>),
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test6, 2.0f,
    ...
    typename TestType::Vector3D4Def testVec1 = TestType::Vector3D4Def(TestType::SIMD3x4Def(
        5.234f, 1.836f, -5.2789f, 1.0f, 7.2654f, -1.0547f, 8.254f, 0.0f, -5.234f, -1.836f, 5.2789f, -1.0f));
    ASSERT_PRED13((assertVector3D4<typename TestFixture::TypeInt, TestFixture::packed, TestType::Vector3D4Def::width>),
        testVec1, 5.234f, 1.836f, -5.2789f, 1.0f, 7.2654f, -1.0547f, 8.254f, 0.0f, -5.234f, -1.836f, 5.2789f, -1.0f);

    TestType test7 = test1 + testVec1;
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test7,
    ...
    ASSERT_PRED13((assertPoint3D4<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test8,
