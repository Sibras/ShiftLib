...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(VECTOR3D)
...
TYPED_TEST_SUITE(TESTISA(Vector3DTest), Vector3DTestTypes);

TYPED_TEST2(TESTISA(Vector3DTest), Vector3D)
{
