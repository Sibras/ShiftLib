...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(VECTOR3D2)
...
using Vector3D2TestTypes = ::testing::Types<Vector3D2<float, SIMDWidth::Scalar, true>,
    Vector3D2<float, SIMDWidth::Scalar, false>, Vector3D2<float, SIMDWidth::B16, true>,
    Vector3D2<float, SIMDWidth::B16, false>, Vector3D2<float, SIMDWidth::B32, true>,
    Vector3D2<float, SIMDWidth::B32,
        false> /*, Vector3D2<float, SIMDWidth::B64, true>, Vector3D2<float, SIMDWidth::B64, false>*/>;

TYPED_TEST_SUITE(TESTISA(Vector3D2Test), Vector3D2TestTypes);

TYPED_TEST2(TESTISA(Vector3D2Test), Vector3D2)
{
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test1,
        10.0f, 4.0f, 7.0f, 5.0f, 2.0f, -2.0f);

    TestType test2 = TestType(TestType::Vector3DDef(5.234f, 1.836f, -5.2789f));
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test2,
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test3,
        5.234f, 1.836f, -5.2789f, 1.0f, 7.2654f, -1.0547f);

    TestType test4 = TestType(test1);
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test4,
        10.0f, 4.0f, 7.0f, 5.0f, 2.0f, -2.0f);
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test6, 2.0f,
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test7,
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test8,
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test9,
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test14,
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test10,
        47.234f, 18.636f, 24.1211f, 22.0f, 15.6654f, -9.4547f);

    TestType test11 = test9 / TestType::BaseDef(5.2f);
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test11,
        10.0f, 4.0f, 7.0f, 5.0f, 2.0f, -2.0f);
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::width, TestFixture::packed>), test12,
        -10.0f, -4.0f, -7.0f, -5.0f, -2.0f, 2.0f);
