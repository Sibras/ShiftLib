...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(POINT3D)
...
TYPED_TEST_SUITE(TESTISA(Point3DTest), Point3DTestTypes);

TYPED_TEST2(TESTISA(Point3DTest), Point3D)
{
