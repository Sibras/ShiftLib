...
#    define XS_OVERRIDE_SHIFT_NS TESTISA(Point3D2Test)
...
using Point3D2TestTypes = ::testing::Types<Point3D2<float, true, SIMDWidth::Scalar>,
    Point3D2<float, false, SIMDWidth::Scalar>, Point3D2<float, true, SIMDWidth::B16>,
    Point3D2<float, false, SIMDWidth::B16>, Point3D2<float, true, SIMDWidth::B32>,
    Point3D2<float, false,
        SIMDWidth::B32> /*, Point3D2<float, true, SIMDWidth::B64>, Point3D2<float, false, SIMDWidth::B64>*/>;

TYPED_TEST_SUITE(TESTISA(P3D2), Point3D2TestTypes);

TYPED_TEST_NS2(Point3D2, TESTISA(P3D2), Point3D2)
{
    using TestType = typename TestFixture::Type;
    TestType test0 = TestType();

    TestType test1 = TestType(10.0f, 5.0f, 4.0f, 2.0f, 7.0f, -2.0f);
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test1, 10.0f,
        4.0f, 7.0f, 5.0f, 2.0f, -2.0f);

    TestType test2 = TestType(TestType::Point3DDef(5.234f, 1.836f, -5.2789f));
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test2,
    ...
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test3,
        5.234f, 1.836f, -5.2789f, 1.0f, 7.2654f, -1.0547f);

    TestType test4 = TestType(test1);
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test4, 10.0f,
        4.0f, 7.0f, 5.0f, 2.0f, -2.0f);

    typename TestType::SIMD6Def temp = TestType::SIMD6Def(5.234f, 1.0f, 1.836f, 7.2654f, -5.2789f, -1.0547f);
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>),
    ...
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test9, 52.0f,
    ...
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test6, 2.0f,
    ...
    ASSERT_PRED7((assertVector3D2<typename TestFixture::TypeInt, TestFixture::packed, TestType::Vector3D2Def::width>),
        testVec1, 5.234f, 1.836f, -5.2789f, 1.0f, 7.2654f, -1.0547f);

    TestType test7 = test1 + testVec1;
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test7,
    ...
    ASSERT_PRED7((assertPoint3D2<typename TestFixture::TypeInt, TestFixture::packed, TestFixture::width>), test8,
