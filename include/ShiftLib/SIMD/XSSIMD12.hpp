...
public:
     ...
     */
    XS_FUNCTION SIMD12(T value0, T value1, T value2, T value3, T value4, T value5, T value6, T value7, T value8,
    ...
    XS_FUNCTION explicit SIMD12(SIMD12<T, Width2> other) noexcept
    {
#if XS_ISA == XS_X86
     ...
     */
    XS_FUNCTION explicit SIMD12(BaseDef other) noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            this->values = other.values;
     ...
     * @param other Value to set all elements to.
     */
    XS_FUNCTION explicit SIMD12(InBaseDef other) noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
     ...
     */
    template<bool EvenIfNotFree = true>
    XS_FUNCTION SIMD12 mad(BaseDef other1, const SIMD12& other2) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
     ...
     */
    template<bool EvenIfNotFree = true>
    XS_FUNCTION SIMD12 mad(const SIMD12& other1, BaseDef other2) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
     ...
     * @returns The maximum value.
     */
    XS_FUNCTION SIMD12 max(BaseDef other) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            return SIMD12(_mm512_max_ps(this->values, other.values));
     ...
     * @returns The minimum value.
     */
    XS_FUNCTION SIMD12 min(BaseDef other) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            return SIMD12(_mm512_min_ps(this->values, other.values));
...
#endif
        {
            return SIMD12(Shift::recip<T>(this->values0), Shift::recip<T>(this->values1),
...
#endif
        {
            return SIMD12(Shift::floor<T>(this->values0), Shift::floor<T>(this->values1),
...
#endif
        {
            return SIMD12(Shift::trunc<T>(this->values0), Shift::trunc<T>(this->values1),
...
#endif
        {
            return SIMD12(Shift::rsqrt<T>(this->values0), Shift::rsqrt<T>(this->values1),
    ...
    XS_FUNCTION SIMD12 exp2() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                _mm512_extractf32x4_ps(res, 0), _mm512_extractf32x4_ps(res, 1), _mm512_extractf32x4_ps(res, 2));
        } else if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
    ...
    XS_FUNCTION SIMD12 exp() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                NoExport::expf4(this->values0), NoExport::expf4(this->values1), NoExport::expf4(this->values2));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD12 log() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                NoExport::logf4(this->values0), NoExport::logf4(this->values1), NoExport::logf4(this->values2));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD12 pow(const SIMD12& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            const __m512 res =
                NoExport::powf16(_mm512_insertf32x4(_mm512_castps256_ps512(this->values0), this->values1, 2),
    ...
    XS_FUNCTION SIMD12 powr(const SIMD12& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                NoExport::powrf8(this->values0, other.values0), NoExport::powrf4(this->values1, other.values1));
        } else if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B16)) {
            ...
            return SIMD12(NoExport::powrf4(this->values0, other.values0),
     ...
     */
    XS_FUNCTION SIMD12 pow(BaseDef other) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            return SIMD12(NoExport::powf16(this->values, other.values));
     ...
     * @returns Object containing the input values to the power of the second input.
     */
    XS_FUNCTION SIMD12 powr(BaseDef other) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            return SIMD12(NoExport::powrf16(this->values, other.values));
    ...
    XS_FUNCTION SIMD12 sin() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                NoExport::sinf4(this->values0), NoExport::sinf4(this->values1), NoExport::sinf4(this->values2));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD12 cos() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                NoExport::cosf4(this->values0), NoExport::cosf4(this->values1), NoExport::cosf4(this->values2));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD12 tan() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                NoExport::tanf4(this->values0), NoExport::tanf4(this->values1), NoExport::tanf4(this->values2));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD12 sincos(SIMD12& cosReturn) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(NoExport::sincosf8(this->values0, cosReturn.values0),
    ...
    XS_FUNCTION SIMD12 atan2(const SIMD12& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD12(
                NoExport::atan2f8(this->values0, other.values0), NoExport::atan2f4(this->values1, other.values1));
        } else if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B16)) {
            ...
            return SIMD12(NoExport::atan2f4(this->values0, other.values0),
    ...
    XS_FUNCTION SIMD12 insert6(const SIMD12& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            if constexpr (hasISAFeature<ISAFeature::SSE41> && Index0 == Index1 && Index0 < 2) {
                return SIMD12(
                    _mm_blend_ps(this->values0, other.values0, 0x5 << (Index0 % 2)), this->values1, this->values2);
            } else if constexpr (hasISAFeature<ISAFeature::SSE41> && Index0 == Index1 && Index0 < 4) {
                return SIMD12(
...
XS_FUNCTION SIMD12<T, Width> operator+(
    const SIMD12<T, Width>& other1, typename SIMD12<T, Width>::BaseDef other2) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD12<T, Width>(_mm512_add_ps(other1.values, other2.values));
...
template<typename T, SIMDWidth Width>
XS_FUNCTION SIMD12<T, Width> operator-(
    typename SIMD12<T, Width>::BaseDef other1, const SIMD12<T, Width>& other2) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD12<T, Width>(_mm512_sub_ps(other1.values, other2.values));
 ...
 */
template<typename T, SIMDWidth Width>
XS_FUNCTION SIMD12<T, Width>& operator+=(SIMD12<T, Width>& other1, typename SIMD12<T, Width>::BaseDef other2) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        other1.values = _mm512_add_ps(other1.values, other2.values);
