...
public:
    ...
    XS_FUNCTION explicit SIMD8(SIMD8<T, Width2> other) noexcept
    {
#if XS_ISA == XS_X86
    ...
    XS_FUNCTION SIMD8 sincos(SIMD8& cosReturn) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
            ...
            return SIMD8(NoExport::sincosf4(this->values0, cosReturn.values0),
        ...
        if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
            ...
            if constexpr (hasISAFeature<ISAFeature::AVX>) {
                ...
                if constexpr (hasISAFeature<ISAFeature::SSE41>) {
                    ...
                    return SIMD8(_mm_castsi128_ps(_mm_or_si128(valLow0, valLow1)),
