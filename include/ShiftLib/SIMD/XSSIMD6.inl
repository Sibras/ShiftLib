...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width>::SIMD6(const BaseDef& other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width>::SIMD6(const InBaseDef& other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD6<T, Width>::setValue(const InBaseDef& other) noexcept
{
    static_assert(Index < 6);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD6<T, Width>::setValue(const BaseDef& other) noexcept
{
    static_assert(Index < 6);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (Index == 0) {
            ...
            const __m256 val =
                _mm256_set_m128(_mm_movehl_ps(other.values, other.values), _mm_unpacklo_ps(other.values, other.values));
            this->values = _mm256_blend_ps(
                this->values, _mm256_permute_ps(val, _MM_SHUFFLE(2, 3, 0, 1)), _MM256_BLEND(1, 0, 1, 0, 1, 0, 1, 0));
        }
    } else if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
        if constexpr (Index == 0) {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD6<T, Width>::addValue(const InBaseDef& other) noexcept
{
    static_assert(Index < 6);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        ...
        if constexpr (Index % 4 == 0) {
            ...
            __m128 value = _mm_permute_ps((&this->values0)[Index / 4], shuffle);
            value = _mm_add_ss(value, other.values);
            (&this->values0)[Index / 4] = _mm_permute_ps(value, shuffle);
        }
    } else
#endif
    {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD6<T, Width>::subValue(const InBaseDef& other) noexcept
{
    static_assert(Index < 6);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD6<T, Width>::mulValue(const InBaseDef& other) noexcept
{
    static_assert(Index < 6);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD6<T, Width>::divValue(const InBaseDef& other) noexcept
{
    static_assert(Index < 6);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::mad(const BaseDef& other1, const SIMD6& other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        return SIMD6(_mm256_fmadd_ps(this->values, other1.values, other2.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::mad(const SIMD6& other1, const BaseDef& other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        return SIMD6(_mm256_fmadd_ps(this->values, other1.values, other2.values));
...
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::mad(const SIMD2Def& other1, const SIMD6& other2) const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (defaultSIMD >= SIMD::AVX2) {
            return SIMD6(_mm256_fmadd_ps(this->values, _mm256_broadcastf64_ps(other1.values), other2.values));
        } else {
            const __m128 val = _mm_shuffle1010_ps(other1.values);
            return SIMD6(_mm256_fmadd_ps(this->values, _mm256_broadcastf128_ps(val), other2.values));
        }
    } else if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
        const __m128 val = _mm_shuffle1010_ps(other1.values);
        return SIMD6(
...
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        return SIMD6(_mm256_fmadd_ps(this->values,
            _mm256_set_m128(
...
template<typename T, SIMDWidth Width>
XS_INLINE typename SIMD6<T, Width>::Mask SIMD6<T, Width>::equalMask(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (defaultSIMD >= SIMD::AVX512) {
...
template<typename T, SIMDWidth Width>
XS_INLINE typename SIMD6<T, Width>::Mask SIMD6<T, Width>::lessOrEqualMask(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (defaultSIMD >= SIMD::AVX512) {
...
template<typename T, SIMDWidth Width>
XS_INLINE typename SIMD6<T, Width>::Mask SIMD6<T, Width>::lessThanMask(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (defaultSIMD >= SIMD::AVX512) {
...
template<typename T, SIMDWidth Width>
XS_INLINE typename SIMD6<T, Width>::Mask SIMD6<T, Width>::greaterOrEqualMask(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (defaultSIMD >= SIMD::AVX512) {
...
template<typename T, SIMDWidth Width>
XS_INLINE typename SIMD6<T, Width>::Mask SIMD6<T, Width>::greaterThanMask(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (defaultSIMD >= SIMD::AVX512) {
...
template<typename T, SIMDWidth Width>
XS_INLINE typename SIMD6<T, Width>::Mask SIMD6<T, Width>::notEqualMask(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (defaultSIMD >= SIMD::AVX512) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::max(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        return SIMD6(_mm256_max_ps(this->values, other.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::min(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        return SIMD6(_mm256_min_ps(this->values, other.values));
...
XS_INLINE typename SIMD6<T, Width>::BaseDef SIMD6<T, Width>::hmax() const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        ...
        val = _mm256_max_ps(_mm256_permute_ps(this->values, _MM_SHUFFLE(1, 0, 3, 2)), val);
        val = _mm256_max_ps(_mm256_permute_ps(val, _MM_SHUFFLE(2, 3, 0, 1)), val);
...
XS_INLINE typename SIMD6<T, Width>::BaseDef SIMD6<T, Width>::hmin() const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        ...
        val = _mm256_min_ps(_mm256_permute_ps(this->values, _MM_SHUFFLE(1, 0, 3, 2)), val);
        val = _mm256_min_ps(_mm256_permute_ps(val, _MM_SHUFFLE(2, 3, 0, 1)), val);
        return BaseDef(_mm256_shuffle1010_ps(val));
    } else if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
...
XS_INLINE typename SIMD6<T, Width>::BaseDef SIMD6<T, Width>::hadd() const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        ...
        val1 = _mm256_add_ps(_mm256_permute_ps(val0, _MM_SHUFFLE(3, 2, 3, 2)),
            _mm256_permute_ps(val1, _MM_SHUFFLE(1, 0, 1, 0))); // additional permutes avoid second high affecting
        return BaseDef(_mm256_add_ps(_mm256_permute_ps(val1, _MM_SHUFFLE(2, 3, 0, 1)), val1));
    } else if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::pow(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        return SIMD6(NoExport::powf8(this->values, other.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::powr(const BaseDef& other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        return SIMD6(NoExport::powrf8(this->values, other.values));
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (Index0 == Index1) {
            ...
            return SIMD6(_mm256_blend_ps(this->values,
                _mm256_permute_ps(other.values, _MM_SHUFFLE(Index1 % 4, Index1 % 4, Index1 % 4, Index1 % 4)),
...
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::insert2(const SIMD6& other) const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (Index0 == 0 && Index1 == 0) {
            ...
            return SIMD6(_mm256_permute_ps(ret, _MM_SHUFFLE(1, 3, 0, 2)));
        } else if constexpr (Index0 == 1 && Index1 == 0) {
            const __m256 ret = _mm256_shuffle_ps(this->values, other.values, _MM_SHUFFLE(2, 0, 2, 0));
            return SIMD6(_mm256_permute_ps(ret, _MM_SHUFFLE(3, 1, 2, 0)));
...
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::insert3(const SIMD6& other) const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
        if constexpr (Index0 == 0 && Index1 == 0) {
            ...
            return SIMD6(_mm256_blend_ps(this->values, _mm256_permute_ps(other.values, _MM_SHUFFLE(3, 2, 3, 2)),
            ...
            return SIMD6(_mm256_blend_ps(this->values, _mm256_permute_ps(other.values, _MM_SHUFFLE(1, 0, 3, 2)),
            ...
            return SIMD6(_mm256_blend_ps(this->values,
                _mm256_permute_ps(_mm256_shuffle32107654_ps(other.values), _MM_SHUFFLE(1, 0, 3, 2)),
                _MM256_BLEND(0, 0, 0, 0, 1, 1, 0, 0))); //(1,0,x,x)
            ...
            return SIMD6(_mm256_blend_ps(this->values,
                _mm256_permute_ps(_mm256_shuffle32107654_ps(other.values), _MM_SHUFFLE(3, 2, 3, 2)),
...
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::blendSwap(SIMD6& other) const noexcept
{
    if constexpr (!Elem0 && !Elem1 && !Elem2 && !Elem3 && !Elem4 && !Elem5) {
        ...
        if constexpr (Elem4 && Elem5) {
            ...
            other.values1 = _mm_permute_ps(val, _MM_SHUFFLE(2, 1, 3, 0));   //(x,x,3,0)
            hi = _mm_permute_ps(val, _MM_SHUFFLE(3, 0, 2, 1));              //(x,x,2,1)
        } else /*Elem4 && !Elem5*/ {
            const __m128 val = _mm_movelh_ps(this->values1, other.values1);   //(a1,a0,b1,b0)
            other.values1 = _mm_permute_ps(val, _MM_SHUFFLE(23, 0, 2, 1));    //(x,x,2,1)
...
XS_INLINE SIMD6<T, Width> SIMD6<T, Width>::shuffle2() const noexcept
{
    ...
    if constexpr (Index0 == 0 && Index1 == 1) {
        ...
        if constexpr (Index0 == 0 && Index1 == 0) {
            ...
            return SIMD6(_mm256_permute_ps(this->values, _MM_SHUFFLE(Index1 + 2, Index0 + 2, Index1, Index0)));
        }
    } else if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
        if constexpr (Index0 == 0 && Index1 == 0) {
            ...
            return SIMD6(_mm_permute_ps(this->values0, _MM_SHUFFLE(2, 3, 0, 1)),
    ...
    if constexpr (Index0 == 0 && Index1 == 1 && Index2 == 2) {
        ...
        if constexpr (Index0 == 0 && Index1 == 0 && Index2 == 0) {
            ...
            return SIMD6(_mm256_set_m128(_mm256_castps256_ps128(this->values),
                _mm_permute_ps(_mm256_castps256_ps128(this->values), _MM_SHUFFLE(1, 0, 3, 2))));
        } else if constexpr (Index0 == 1 && Index1 == 0 && Index2 == 1) {
            const __m128 val = _mm_permute_ps(_mm256_castps256_ps128(this->values), _MM_SHUFFLE(1, 0, 3, 2));
            ...
            const __m256 val1 = _mm256_permute_ps(this->values, _MM_SHUFFLE(3, 2, 3, 2));
        ...
        if constexpr (Index0 == 0 && Index1 == 0 && Index2 == 0) {
            ...
            return SIMD6(_mm_permute_ps(this->values0, _MM_SHUFFLE(1, 0, 3, 2)), this->values0);
        } else if constexpr (Index0 == 1 && Index1 == 0 && Index2 == 1) {
            const __m128 val = _mm_permute_ps(this->values0, _MM_SHUFFLE(1, 0, 3, 2));
            return SIMD6(val, val);
        } else if constexpr (Index0 == 1 && Index1 == 0 && Index2 == 2) {
            return SIMD6(_mm_permute_ps(this->values0, _MM_SHUFFLE(1, 0, 3, 2)), this->values1);
        } else if constexpr (Index0 == 1 && Index1 == 1 && Index2 == 0) {
