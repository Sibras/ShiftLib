...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x4<T, Width>::SIMD3x4(BaseDef other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x4<T, Width>::SIMD3x4(InBaseDef other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
    ...
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        ...
        if constexpr (hasISAFeature<ISAFeature::AVX2>) {
            const __m256 val0 = _mm256_castpd_ps(_mm256_permute4x64_pd(
                _mm256_castps_pd(_mm256_shuffle1_ps(other.values0, _MM_SHUFFLE(3, 1, 2, 0))), _MM_SHUFFLE(3, 1, 2, 0)));
...
template<typename T, SIMDWidth Width>
template<bool EvenIfNotFree>
XS_INLINE SIMD3x4<T, Width> SIMD3x4<T, Width>::mad(BaseDef other1, const SIMD3x4& other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
...
template<typename T, SIMDWidth Width>
template<bool EvenIfNotFree>
XS_INLINE SIMD3x4<T, Width> SIMD3x4<T, Width>::mad(const SIMD3x4& other1, BaseDef other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x4<T, Width> SIMD3x4<T, Width>::max(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD3x4(_mm512_max_ps(this->values, other.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x4<T, Width> SIMD3x4<T, Width>::min(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD3x4(_mm512_min_ps(this->values, other.values));
...
XS_INLINE SIMD3x4<T, Width> SIMD3x4<T, Width>::cross3(const SIMD3x4& other) const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        ...
        return SIMD3x4(_mm_shuffle1_ps(val1A, _MM_SHUFFLE(3, 0, 2, 1)), _mm_shuffle1_ps(val1B, _MM_SHUFFLE(3, 0, 2, 1)),
            _mm_shuffle1_ps(val1C, _MM_SHUFFLE(3, 0, 2, 1)), _mm_shuffle1_ps(val1D, _MM_SHUFFLE(3, 0, 2, 1)));
    } else
#endif
    {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x4<T, Width>& operator+=(SIMD3x4<T, Width>& other1, typename SIMD3x4<T, Width>::BaseDef other2) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        other1.values = _mm512_add_ps(other1.values, other2.values);
