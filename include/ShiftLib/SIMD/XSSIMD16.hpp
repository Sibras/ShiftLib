...
class alignas(sizeof(T) * 16) SIMD16Data
{
...
public:
    ...
    T m_value12, m_value13, m_value14, m_value15;
...
public:
    ...
    XS_FUNCTION explicit SIMD16(const SIMDBase<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION explicit SIMD16(const SIMDInBase<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION SIMD16(const SIMD2<T, Width>& other0, const SIMD2<T, Width>& other1, const SIMD2<T, Width>& other2,
        const SIMD2<T, Width>& other3, const SIMD2<T, Width>& other4, const SIMD2<T, Width>& other5,
        const SIMD2<T, Width>& other6, const SIMD2<T, Width>& other7) noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD2<T, Width>, SIMD2<T, Width2>>))
    XS_FUNCTION explicit SIMD16(const SIMD2<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION SIMD16(const SIMD4<T, Width2>& other0, const SIMD4<T, Width2>& other1, const SIMD4<T, Width2>& other2,
        const SIMD4<T, Width2>& other3) noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD4<T, Width>, SIMD4<T, Width2>>))
    XS_FUNCTION explicit SIMD16(const SIMD4<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION SIMD16(const SIMD8<T, Width2>& other0, const SIMD8<T, Width2>& other1) noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD8<T, Width>, SIMD8<T, Width2>>))
    XS_FUNCTION explicit SIMD16(const SIMD8<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION SIMD16(const SIMD12<T, Width2>& other0, const SIMD4<T, Width2>& other1) noexcept;
    ...
    XS_FUNCTION SIMD16(const SIMD3x4<T, Width2>& other0, const SIMD4<T, Width2>& other1) noexcept;

    /**
     * Constructor.
     * @param data The data.
     */
    XS_FUNCTION explicit SIMD16(const Data& data) noexcept;
    ...
    template<uint32 Index, SIMDWidth Width2 = Width>
    XS_REQUIRES((sameImpl<SIMD8<T, Width>, SIMD8<T, Width2>>))
    XS_FUNCTION SIMD8<T, Width2> getValue8() const noexcept;
    ...
    XS_FUNCTION SIMD12<T, Width2> getValue4x3() const noexcept;
    ...
    XS_FUNCTION SIMD3x4<T, Width2> getValue3x4() const noexcept;
    ...
    template<uint32 Index, SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD8<T, Width>, SIMD8<T, Width2>>))
    XS_FUNCTION void setValue8(const SIMD8<T, Width2>& other) noexcept;
     ...
     */
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 mad(const SIMD16<T, Width2>& other1, const SIMD16<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD16 mad(const SIMDBase<T, Width2>& other1, const SIMD16<T, Width>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD16 mad(const SIMD16<T, Width>& other1, const SIMDBase<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD4<T, Width>, SIMD4<T, Width2>>))
    XS_FUNCTION SIMD16 mad(const SIMD4<T, Width2>& other1, const SIMD4<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD4<T, Width>, SIMD4<T, Width2>>))
    XS_FUNCTION SIMD16 mad(const SIMD4<T, Width2>& other1, const SIMD16<T, Width>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD8<T, Width>, SIMD8<T, Width2>>))
    XS_FUNCTION SIMD16 mad(const SIMD8<T, Width2>& other1, const SIMD8<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD8<T, Width>, SIMD8<T, Width2>>))
    XS_FUNCTION SIMD16 mad(const SIMD8<T, Width2>& other1, const SIMD16<T, Width>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 sign(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 max(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 min(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD16 max(const SIMDBase<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD16 min(const SIMDBase<T, Width2>& other) const noexcept;
     ...
     */
    XS_FUNCTION SIMD8<T, Width> max8() const noexcept;

    /**
     * Minimum of each internally stored SIMD8.
     * @returns SIMD8 set to the largest value between each internal SIMD8.
     */
    XS_FUNCTION SIMD8<T, Width> min8() const noexcept;
     ...
     */
    XS_FUNCTION SIMD8<T, Width> add8() const noexcept;
     ...
     */
    XS_FUNCTION SIMD8<T, Width> sub8() const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD4<T, Width> dot4(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 pow(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 powr(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD16 pow(const SIMDBase<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD16 powr(const SIMDBase<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 atan2(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<uint32 Index0, uint32 Index1, SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 insert2(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<uint32 Index0, uint32 Index1, SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 insert4(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<uint32 Index0, uint32 Index1, SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 insert8(const SIMD16<T, Width2>& other) const noexcept;
    ...
    template<bool Elem0, bool Elem1, bool Elem2, bool Elem3, bool Elem4, bool Elem5, bool Elem6, bool Elem7,
        SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 blend8(const SIMD16<T, Width2>& other) const noexcept;
    ...
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 blend4(const SIMD16<T, Width2>& other) const noexcept;
    ...
    XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
    XS_FUNCTION SIMD16 blend2(const SIMD16<T, Width2>& other) const noexcept;
...
XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
XS_FUNCTION SIMD16<T, Width> operator+(const SIMD16<T, Width>& other1, const SIMD16<T, Width2>& other2) noexcept;
 ...
 */
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<typename SIMD16<T, Width>::BaseDef, SIMDBase<T, Width2>>))
XS_FUNCTION SIMD16<T, Width> operator+(const SIMD16<T, Width>& other1, const SIMDBase<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD4<T, Width>, SIMD4<T, Width2>>))
XS_FUNCTION SIMD16<T, Width> operator+(const SIMD16<T, Width>& other1, const SIMD4<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD8<T, Width>, SIMD8<T, Width2>>))
XS_FUNCTION SIMD16<T, Width> operator+(const SIMD16<T, Width>& other1, const SIMD8<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<typename SIMD16<T, Width>::BaseDef, SIMDBase<T, Width2>>))
XS_FUNCTION SIMD16<T, Width> operator-(const SIMDBase<T, Width2>& other1, const SIMD16<T, Width>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD16<T, Width>, SIMD16<T, Width2>>))
XS_FUNCTION SIMD16<T, Width>& operator+=(SIMD16<T, Width>& other1, const SIMD16<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<typename SIMD16<T, Width>::BaseDef, SIMDBase<T, Width2>>))
XS_FUNCTION SIMD16<T, Width>& operator+=(SIMD16<T, Width>& other1, const SIMDBase<T, Width2>& other2) noexcept;
