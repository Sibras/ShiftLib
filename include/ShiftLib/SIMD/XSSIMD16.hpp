...
public:
...
#endif
        {
            return SIMD16(Shift::recip<T>(this->values0), Shift::recip<T>(this->values1),
                ...
                Shift::recip<T>(this->values11), Shift::recip<T>(this->values12), Shift::recip<T>(this->values13),
                Shift::recip<T>(this->values14), Shift::recip<T>(this->values15));
        }
    }
...
#endif
        {
            return SIMD16(Shift::floor<T>(this->values0), Shift::floor<T>(this->values1),
                ...
                Shift::floor<T>(this->values11), Shift::floor<T>(this->values12), Shift::floor<T>(this->values13),
                Shift::floor<T>(this->values14), Shift::floor<T>(this->values15));
        }
    }
...
#endif
        {
            return SIMD16(Shift::trunc<T>(this->values0), Shift::trunc<T>(this->values1),
                ...
                Shift::trunc<T>(this->values11), Shift::trunc<T>(this->values12), Shift::trunc<T>(this->values13),
                Shift::trunc<T>(this->values14), Shift::trunc<T>(this->values15));
        }
    }
    ...
    XS_FUNCTION SIMD16 rsqrt() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(_mm_mul_ps(recip0, val02), _mm_mul_ps(recip1, val12), _mm_mul_ps(recip2, val22),
                _mm_mul_ps(recip3, val32));
        } else
#endif
        {
            return SIMD16(Shift::rsqrt<T>(this->values0), Shift::rsqrt<T>(this->values1),
                ...
                Shift::rsqrt<T>(this->values11), Shift::rsqrt<T>(this->values12), Shift::rsqrt<T>(this->values13),
                Shift::rsqrt<T>(this->values14), Shift::rsqrt<T>(this->values15));
        }
    }
    ...
    XS_FUNCTION SIMD16 exp2() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(_mm512_extractf32x4_ps(res, 0), _mm512_extractf32x4_ps(res, 1),
                _mm512_extractf32x4_ps(res, 2), _mm512_extractf32x4_ps(res, 3));
        } else if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
            ...
            return SIMD16(NoExport::exp2f4(this->values0), NoExport::exp2f4(this->values1),
                NoExport::exp2f4(this->values2), NoExport::exp2f4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 exp() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::expf4(this->values0), NoExport::expf4(this->values1),
                NoExport::expf4(this->values2), NoExport::expf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 log2() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::log2f4(this->values0), NoExport::log2f4(this->values1),
                NoExport::log2f4(this->values2), NoExport::log2f4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 log() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::logf4(this->values0), NoExport::logf4(this->values1),
                NoExport::logf4(this->values2), NoExport::logf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 pow(const SIMD16& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            const __m512 res =
                NoExport::powf16(_mm512_set_m128(this->values3, this->values2, this->values1, this->values0),
    ...
    XS_FUNCTION SIMD16 powr(const SIMD16& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(
                NoExport::powrf8(this->values0, other.values0), NoExport::powrf8(this->values1, other.values1));
        } else if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B16)) {
            ...
            return SIMD16(NoExport::powrf4(this->values0, other.values0),
                NoExport::powrf4(this->values1, other.values1), NoExport::powrf4(this->values2, other.values2),
                NoExport::powrf4(this->values3, other.values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 pow(BaseDef other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            const __m512 res =
                NoExport::powf16(_mm512_set_m128(this->values1, this->values0, this->values3, this->values2),
    ...
    XS_FUNCTION SIMD16 sin() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::sinf4(this->values0), NoExport::sinf4(this->values1),
                NoExport::sinf4(this->values2), NoExport::sinf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 cos() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::cosf4(this->values0), NoExport::cosf4(this->values1),
                NoExport::cosf4(this->values2), NoExport::cosf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 tan() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::tanf4(this->values0), NoExport::tanf4(this->values1),
                NoExport::tanf4(this->values2), NoExport::tanf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 sincos(SIMD16& cosReturn) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::sincosf8(this->values0, cosReturn.values0),
                NoExport::sincosf8(this->values1, cosReturn.values1));
        } else if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B16)) {
            __m256 ret0, ret1;
            ...
            return SIMD16(NoExport::sincosf4(this->values0, cosReturn.values0),
                ...
                NoExport::sincosf4(this->values2, cosReturn.values2),
...
#endif
        {
            return SIMD16(Shift::sincos<T>(this->values0, cosReturn.values0),
                ...
                Shift::sincos<T>(this->values9, cosReturn.values9),
                Shift::sincos<T>(this->values10, cosReturn.values10),
                Shift::sincos<T>(this->values11, cosReturn.values11),
                Shift::sincos<T>(this->values12, cosReturn.values12),
                Shift::sincos<T>(this->values13, cosReturn.values13),
                Shift::sincos<T>(this->values14, cosReturn.values14),
    ...
    XS_FUNCTION SIMD16 asin() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::asinf4(this->values0), NoExport::asinf4(this->values1),
                NoExport::asinf4(this->values2), NoExport::asinf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 acos() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::acosf4(this->values0), NoExport::acosf4(this->values1),
                NoExport::acosf4(this->values2), NoExport::acosf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 atan() const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(NoExport::atanf4(this->values0), NoExport::atanf4(this->values1),
                NoExport::atanf4(this->values2), NoExport::atanf4(this->values3));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD16 atan2(const SIMD16& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
            ...
            return SIMD16(
                NoExport::atan2f8(this->values0, other.values0), NoExport::atan2f8(this->values1, other.values1));
        } else if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B16)) {
            ...
            return SIMD16(NoExport::atan2f4(this->values0, other.values0),
                NoExport::atan2f4(this->values1, other.values1), NoExport::atan2f4(this->values2, other.values2),
                NoExport::atan2f4(this->values3, other.values3));
        } else
#endif
        {
