...
public:
    ...
    XS_FUNCTION explicit SIMD3x2(SIMD3x2<T, Width2> other) noexcept
    {
#if XS_ISA == XS_X86
...
#endif
        {
            return SIMD3x2(Shift::recip<T>(this->values0), Shift::recip<T>(this->values1),
                Shift::recip<T>(this->values2), Shift::recip<T>(this->values3), Shift::recip<T>(this->values4),
                Shift::recip<T>(this->values5));
        }
    }
...
#endif
        {
            return SIMD3x2(Shift::floor<T>(this->values0), Shift::floor<T>(this->values1),
                Shift::floor<T>(this->values2), Shift::floor<T>(this->values3), Shift::floor<T>(this->values4),
                Shift::floor<T>(this->values5));
        }
    }
...
#endif
        {
            return SIMD3x2(Shift::trunc<T>(this->values0), Shift::trunc<T>(this->values1),
                Shift::trunc<T>(this->values2), Shift::trunc<T>(this->values3), Shift::trunc<T>(this->values4),
                Shift::trunc<T>(this->values5));
        }
    }
...
#endif
        {
            return SIMD3x2(Shift::rsqrt<T>(this->values0), Shift::rsqrt<T>(this->values1),
                Shift::rsqrt<T>(this->values2), Shift::rsqrt<T>(this->values3), Shift::rsqrt<T>(this->values4),
                Shift::rsqrt<T>(this->values5));
        }
    }
    ...
    XS_FUNCTION SIMD3x2 pow(const SIMD3x2& other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
            ...
            return SIMD3x2(
                NoExport::powf4(this->values0, other.values0), NoExport::powf4(this->values1, other.values1));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD3x2 powr(BaseDef other) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
            ...
            return SIMD3x2(
                NoExport::powrf4(this->values0, other.values), NoExport::powrf4(this->values1, other.values));
        } else
#endif
        {
    ...
    XS_FUNCTION SIMD3x2 sincos(SIMD3x2& cosReturn) const noexcept
    {
        ...
        if constexpr (isSame<T, float32> && hasSIMD256<T> && (Width >= SIMDWidth::B32)) {
            ...
            return SIMD3x2(NoExport::sincosf4(this->values0, cosReturn.values0),
