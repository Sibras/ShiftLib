...
class alignas(sizeof(T) * 2) SIMD6Data
{
...
template<typename T>
XS_REQUIRES(isArithmetic<T>)
class alignas(sizeof(T) * 8) SIMD6DataPad
{
    static_assert(isArithmetic<T>);

public:
    T m_value0, m_value1, m_value2, m_value3;
    T m_value4, m_value5, m_fPad0, m_fPad1;
...
public:
    ...
    class Mask
    {
         ...
         * @returns The bool.
         */
        XS_FUNCTION Bool6<hasSIMD<T> && (Width > SIMDWidth::Scalar)> getBool6() const noexcept;
    ...
    /**
     * Hex shuffle class used to store shuffle information for SIMD6s. Currently limited to only shuffling within dual
     * values.
     */
    class Shuffle
    {
        ...
        XS_FUNCTION static Shuffle Swap2(const typename SIMD3<T, Width2>::Mask& mask) noexcept;
    };
    ...
    XS_FUNCTION explicit SIMD6(const SIMDBase<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION explicit SIMD6(const SIMDInBase<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION
        SIMD6(const SIMD2<T, Width2>& other0, const SIMD2<T, Width2>& other1, const SIMD2<T, Width2>& other2) noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD2<T, Width>, SIMD2<T, Width2>>))
    XS_FUNCTION explicit SIMD6(const SIMD2<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION SIMD6(const SIMD3<T, Width2>& other0, const SIMD3<T, Width2>& other1) noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD3<T, Width>, SIMD3<T, Width2>>))
    XS_FUNCTION explicit SIMD6(const SIMD3<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION explicit SIMD6(const SIMD3x2<T, Width2>& other) noexcept;
    ...
    XS_FUNCTION SIMD6(const SIMD4<T, Width2>& other0, const SIMD2<T, Width2>& other1) noexcept;

    /**
     * Constructor.
     * @param data The data.
     */
    XS_FUNCTION explicit SIMD6(const Data& data) noexcept;
    ...
    XS_FUNCTION SIMD6 mad(const SIMD6<T, Width2>& other1, const SIMD6<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD6 mad(const SIMDBase<T, Width2>& other1, const SIMD6<T, Width>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD6 mad(const SIMD6<T, Width>& other1, const SIMDBase<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD2<T, Width>, SIMD2<T, Width2>>))
    XS_FUNCTION SIMD6 mad(const SIMD2<T, Width2>& other1, const SIMD6<T, Width>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD3<T, Width>, SIMD3<T, Width2>>))
    XS_FUNCTION SIMD6 mad(const SIMD3<T, Width2>& other1, const SIMD6<T, Width>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD3<T, Width>, SIMD3<T, Width2>>))
    XS_FUNCTION SIMD6 mad(const SIMD3<T, Width2>& other1, const SIMD3<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 msub(const SIMD6<T, Width2>& other1, const SIMD6<T, Width2>& other2) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION Mask equalMask(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION Mask lessOrEqualMask(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION Mask lessThanMask(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION Mask notEqualMask(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 sign(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 max(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 min(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD6 max(const SIMDBase<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD6 min(const SIMDBase<T, Width2>& other) const noexcept;
     ...
     */
    XS_FUNCTION SIMD3<T, Width> hmax2() const noexcept;

    /**
     * Minimum element from each SIMD2.
     * @returns SIMD3 set to the smallest value in each SIMD2.
     */
    XS_FUNCTION SIMD3<T, Width> hmin2() const noexcept;
    ...
    /**
     * Reciprocal (1/other) of SIMD6 per element.
     * @returns The result of the operation.
     */
     ...
     */
    XS_FUNCTION SIMD3<T, Width> hadd2() const noexcept;
     ...
     */
    XS_FUNCTION SIMD3<T, Width> hsub2() const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD2<T, Width> dot3(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 cross3(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 pow(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 powr(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD6 pow(const SIMDBase<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<BaseDef, SIMDBase<T, Width2>>))
    XS_FUNCTION SIMD6 powr(const SIMDBase<T, Width2>& other) const noexcept;
     ...
     */
    XS_FUNCTION SIMD12<T, Width> sincos() const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 atan2(const SIMD6<T, Width2>& other) const noexcept;
    ...
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 insert(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<uint32 Index0, uint32 Index1, SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 insert2(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<uint32 Index0, uint32 Index1, SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 insert3(const SIMD6<T, Width2>& other) const noexcept;
    ...
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 blend(const SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 blendVar(const SIMD6<T, Width2>& other, const Mask& mask) const noexcept;
    ...
    template<bool Elem0, bool Elem1, bool Elem2, bool Elem3, bool Elem4, bool Elem5, SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 blendSwap(SIMD6<T, Width2>& other) const noexcept;
    ...
    template<SIMDWidth Width2>
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 blendSwapVar(SIMD6<T, Width2>& other, const Mask& mask) const noexcept;
    ...
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 blend2(const SIMD6<T, Width2>& other) const noexcept;
    ...
    XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
    XS_FUNCTION SIMD6 blend3(const SIMD6<T, Width2>& other) const noexcept;
    ...
    XS_FUNCTION SIMD6 shuffle() const noexcept;
...
XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
XS_FUNCTION SIMD6<T, Width> operator+(const SIMD6<T, Width>& other1, const SIMD6<T, Width2>& other2) noexcept;
...
XS_FUNCTION SIMD6<T, Width> operator+(const SIMD6<T, Width>& other1, const SIMDBase<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD2<T, Width>, SIMD2<T, Width2>>))
XS_FUNCTION SIMD6<T, Width> operator+(const SIMD6<T, Width>& other1, const SIMD2<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD3<T, Width>, SIMD3<T, Width2>>))
XS_FUNCTION SIMD6<T, Width> operator+(const SIMD6<T, Width>& other1, const SIMD3<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<typename SIMD6<T, Width>::BaseDef, SIMDBase<T, Width2>>))
XS_FUNCTION SIMD6<T, Width> operator-(const SIMDBase<T, Width2>& other1, const SIMD6<T, Width>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<typename SIMD6<T, Width>::BaseDef, SIMDBase<T, Width2>>))
XS_FUNCTION SIMD6<T, Width> operator/(const SIMDBase<T, Width2>& other1, const SIMD6<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
XS_FUNCTION SIMD6<T, Width>& operator+=(SIMD6<T, Width>& other1, const SIMD6<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<typename SIMD6<T, Width>::BaseDef, SIMDBase<T, Width2>>))
XS_FUNCTION SIMD6<T, Width>& operator+=(SIMD6<T, Width>& other1, const SIMDBase<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD2<T, Width>, SIMD2<T, Width2>>))
XS_FUNCTION SIMD6<T, Width>& operator+=(SIMD6<T, Width>& other1, const SIMD2<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD3<T, Width>, SIMD3<T, Width2>>))
XS_FUNCTION SIMD6<T, Width>& operator+=(SIMD6<T, Width>& other1, const SIMD3<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<SIMD6<T, Width>, SIMD6<T, Width2>>))
XS_FUNCTION bool operator==(const SIMD6<T, Width>& other1, const SIMD6<T, Width2>& other2) noexcept;
...
template<typename T, SIMDWidth Width, SIMDWidth Width2>
XS_REQUIRES((sameImpl<typename SIMD6<T, Width>::BaseDef, SIMDBase<T, Width2>>))
XS_FUNCTION bool operator==(const SIMD6<T, Width>& other1, const SIMDBase<T, Width2>& other2) noexcept;
