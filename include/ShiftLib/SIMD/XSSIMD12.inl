...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD12<T, Width>::SIMD12(BaseDef other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD12<T, Width>::SIMD12(InBaseDef other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD12<T, Width>::setValue(BaseDef other) noexcept
{
    static_assert(Index < 12);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
...
template<typename T, SIMDWidth Width>
template<uint32 Index>
XS_INLINE void SIMD12<T, Width>::setValue(InBaseDef other) noexcept
{
    static_assert(Index < 12);
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
...
template<typename T, SIMDWidth Width>
template<bool EvenIfNotFree>
XS_INLINE SIMD12<T, Width> SIMD12<T, Width>::mad(BaseDef other1, const SIMD12& other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
...
template<typename T, SIMDWidth Width>
template<bool EvenIfNotFree>
XS_INLINE SIMD12<T, Width> SIMD12<T, Width>::mad(const SIMD12& other1, BaseDef other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
...
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        const __m512 val0 = _mm512_insertf32x4(_mm512_castps256_ps512(_mm256_set_m128(_mm_shuffle1111_ps(other1.values),
                                                   _mm_shuffle0000_ps(other1.values))),
            _mm_shuffle2222_ps(other1.values), 2);
        const __m512 val1 = _mm512_insertf32x4(_mm512_castps256_ps512(_mm256_set_m128(_mm_shuffle1111_ps(other2.values),
        ...
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
            ...
            return SIMD12(_mm256_add_ps(_mm256_mul_ps(this->values0, val0), val1),
                _mm_add_ps(
                    _mm_mul_ps(this->values1, _mm_shuffle2222_ps(other1.values)), _mm_shuffle2222_ps(other2.values)));
        }
    } else if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
            return SIMD12(
            ...
            return SIMD12(_mm_add_ps(_mm_mul_ps(this->values0, _mm_shuffle0000_ps(other1.values)),
                              _mm_shuffle0000_ps(other2.values)),
                _mm_add_ps(
                    _mm_mul_ps(this->values1, _mm_shuffle1111_ps(other1.values)), _mm_shuffle1111_ps(other2.values)),
                _mm_add_ps(
                    _mm_mul_ps(this->values2, _mm_shuffle2222_ps(other1.values)), _mm_shuffle2222_ps(other2.values)));
        }
    } else
#endif
    {
...
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        const __m512 val = _mm512_insertf32x4(_mm512_castps256_ps512(_mm256_set_m128(_mm_shuffle1111_ps(other1.values),
                                                  _mm_shuffle0000_ps(other1.values))),
            _mm_shuffle2222_ps(other1.values), 2);
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD12<T, Width> SIMD12<T, Width>::max(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD12(_mm512_max_ps(this->values, other.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD12<T, Width> SIMD12<T, Width>::min(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD12(_mm512_min_ps(this->values, other.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD12<T, Width> SIMD12<T, Width>::pow(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD12(NoExport::powf16(this->values, other.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD12<T, Width> SIMD12<T, Width>::powr(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD12(NoExport::powrf16(this->values, other.values));
