...
public:
    ...
    XS_FUNCTION SIMD3 ceil() const noexcept
    {
        ...
        {
            return SIMD3(
                (Shift::ceil<T>(this->values0)), (Shift::ceil<T>(this->values1)), (Shift::ceil<T>(this->values2)));
        }
    }
    ...
    XS_FUNCTION SIMD3 rsqrt() const noexcept
    {
        ...
        {
            return SIMD3(
                Shift::rsqrt<T>(this->values0), Shift::rsqrt<T>(this->values1), Shift::rsqrt<T>(this->values2));
        }
    }
     ...
     */
    XS_FUNCTION SIMD3 pow(BaseDef other) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
            return SIMD3(NoExport::powf4(this->values, other.values));
     ...
     * @returns Object containing the input values to the power of the second input.
     */
    XS_FUNCTION SIMD3 powr(BaseDef other) const noexcept
    {
#if XS_ISA == XS_X86
        if constexpr (isSame<T, float32> && hasSIMD128<T> && (Width >= SIMDWidth::B16)) {
            return SIMD3(NoExport::powrf4(this->values, other.values));
