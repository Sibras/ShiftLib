...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x3<T, Width>::SIMD3x3(BaseDef other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x3<T, Width>::SIMD3x3(InBaseDef other) noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
    ...
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        if constexpr (Index == 0) {
            ...
            return BaseDef(_mm512_shuffle_f32x4(
                _mm512_shuffle1_ps(this->values, _MM_SHUFFLE(Index % 3, Index % 3, Index % 3, Index % 3)), this->values,
...
template<typename T, SIMDWidth Width>
template<bool EvenIfNotFree>
XS_INLINE SIMD3x3<T, Width> SIMD3x3<T, Width>::mad(BaseDef other1, const SIMD3x3& other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
...
template<typename T, SIMDWidth Width>
template<bool EvenIfNotFree>
XS_INLINE SIMD3x3<T, Width> SIMD3x3<T, Width>::mad(const SIMD3x3& other1, BaseDef other2) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        if constexpr (hasFMA<T> && (EvenIfNotFree || hasFMAFree<T>)) {
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x3<T, Width> SIMD3x3<T, Width>::max(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD3x3(_mm512_max_ps(this->values, other.values));
...
template<typename T, SIMDWidth Width>
XS_INLINE SIMD3x3<T, Width> SIMD3x3<T, Width>::min(BaseDef other) const noexcept
{
#if XS_ISA == XS_X86
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        return SIMD3x3(_mm512_min_ps(this->values, other.values));
...
XS_INLINE SIMD3x3<T, Width> SIMD3x3<T, Width>::cross3(const SIMD3x3& other) const noexcept
{
    ...
    if constexpr (isSame<T, float32> && hasSIMD512<T> && (Width >= SIMDWidth::B64)) {
        ...
        val1C = _mm_sub_ps(val1C, val2C);
        return SIMD3x3(_mm_shuffle1_ps(val1A, _MM_SHUFFLE(3, 0, 2, 1)), _mm_shuffle1_ps(val1B, _MM_SHUFFLE(3, 0, 2, 1)),
            _mm_shuffle1_ps(val1C, _MM_SHUFFLE(3, 0, 2, 1)));
    } else
#endif
    {
