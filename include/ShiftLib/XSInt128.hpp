...
public:
    ...
    XS_INLINE constexpr Int128() noexcept
        : high(0_i64)
        , low(0_ui64)
    {}
    ...
    XS_INLINE constexpr explicit operator UInt128() const noexcept
    {
        return UInt128(static_cast<uint64>(high), low);
    }
    ...
    XS_INLINE constexpr Int128 operator~() const noexcept
    {
    ...
    XS_INLINE Int128 operator<<(T other) const noexcept
    {
        if constexpr (currentArch == Architecture::Bit64 &&
            ...
            return (other < 64) ? Int128((high << static_cast<uint8>(other)) +
                                          static_cast<int64>(low >> (64_ui8 - static_cast<uint8>(other))),
                                      low << static_cast<uint8>(other)) :
                                  Int128(static_cast<int64>(low << static_cast<uint8>(other - 64_ui8)), 0_ui64);
        }
    }
    ...
    XS_INLINE Int128 operator>>(T other) const noexcept
    {
        if constexpr (currentArch == Architecture::Bit64 &&
            ...
            return (other < 64) ?
                Int128(high >> static_cast<uint8>(other),
                    (high << (64_ui8 - static_cast<uint8>(other))) +
                        static_cast<int64>(low >> static_cast<uint8>(other))) :
                Int128(high >> 63_ui8, static_cast<uint64>(high) >> static_cast<uint8>(other - 64_ui8));
        }
    }
    ...
    XS_INLINE Int128& operator++() noexcept
    {
        *this += 1_i64;
        return *this;
    }

    XS_INLINE Int128 operator++(int) noexcept
    {
    ...
    XS_INLINE Int128 operator-() const noexcept
    {
        return ~(*this) + 1_i64;
    }
};
