...
public:
    ...
    XS_FUNCTION constexpr explicit operator UInt128() const noexcept
    {
...
XS_FUNCTION constexpr Int128 operator"" _i128(unsigned long long v) noexcept // NOLINT(google-runtime-int)
{
    return Int128(v);
}
